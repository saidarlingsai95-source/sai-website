...
<p class="desc">Hi! I built this website myself using Python & Flask. I love coding and creating cool things! 🚀</p>
<div class="skills">
...
<a class="whatsapp" href="https://wa.me/919000000000" target="_blank"><i class="fab fa-whatsapp"></i></a>
<a class="github" href="https://github.com/saidarlingsai95-source" target="_blank"><i class="fab fa-github"></i></a>
</div>
<a class="btn btn-primary" href="https://github.com/saidarlingsai95-source" target="_blank"><i class="fab fa-github"></i> My GitHub</a>
<a class="btn btn-dark" href="https://instagram.com/sainaveen_8" target="_blank"><i class="fab fa-instagram"></i> Follow Me</a>
<p class="live">● LIVE WEBSITE - BUILT BY SAI</p>
</div>
</body>
</html>
    '''
